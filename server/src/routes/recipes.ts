...
router.delete('/get-recipes/:delete',authMiddleware,async(req:AuthRequest,res:Response)=>{
    try {
        ...
        res.status(200).json({success:true, message:"Recipe deleted", data:recipeToDelete});
    } catch (e) {
        console.log(e);
